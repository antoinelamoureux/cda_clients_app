 ...
 */
package com.antoinelamoureux.tp_angular_clients.services;

import com.antoinelamoureux.tp_angular_clients.entities.Clients;
...
public class ClientsFacadeREST extends AbstractFacade<Clients> {
    ...
    public void create(Clients entity) {
        System.out.println("CREATE : " + entity.getNom());
        super.create(entity);
    }
    ...
    public void edit(@PathParam("id") Integer id, Clients entity) {
        System.out.println("UPDATE : " + entity.getNom());
        super.edit(entity);
    }
